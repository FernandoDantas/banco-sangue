...
<head>
    ...
    <title>@yield('title') - Banco Sangue</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Banco de sangue</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('donors.index')}}">
                    ...
                    <span>Doadores de sangue</span></a>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Banco de sangue {{ date('Y')}}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
